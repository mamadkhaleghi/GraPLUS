...
class ImageDataset(Dataset):
    def __init__(self, istrain=True):
        ...
        if istrain:
            ...
            ################################################################
            # self.refer_features = np.load(opt.test_reference_feature_path)  #this line has changed
            self.refer_features = np.load(opt.test_reference_feature_path, allow_pickle=True)
            ################################################################
    ...
    def __getitem__(self, index):
        ...
        #=========================================================================================== modified
        # Add a check to handle NoneType for refer_box
        # if refer_box is None:
        #     refer_box = np.zeros((opt.refer_num, 6))  # Adjust the shape according to your needs
