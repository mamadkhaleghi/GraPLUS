...
class SysNet(nn.Module):
    ...
    def forward(self, bg_img, fg_img, fg_msk, fg_bbox, comp_img=None, comp_msk=None):
        ...
        if comp_img is None:
            return blend_img_1, blend_msk_1, trans_1  # used at "inference" mode
        ...
        return blend_img_1, blend_msk_1, trans_1, blend_img_2, blend_msk_2, trans_2, mu, logvar # used at "train" mode
