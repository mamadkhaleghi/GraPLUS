...
with warnings.catch_warnings():
    ...
    import tensorboard_logger as tb_logger
                                                                            #####             #####
from tool.utils import make_dirs, save, resume, make_logger, AverageMeter, save_loss_to_csv , plot_loss_from_csv
    ...
    for epoch in range(start_ep, opt.n_epochs):
        for i, (indices, bg_img_feats, fg_img_feats, fg_msk_feats, fg_bboxes, comp_img_feats, comp_msk_feats, comp_crop_feats, labels, trans_labels, catnms) in enumerate(train_loader):
            ...
            if (epoch * len(train_loader) + i) % 10 == 0:
                ...
                save_loss_to_csv(loss_csv_file_path, epoch+1, i+1,
                                 g_gan_loss1_meter.avg, g_gan_loss2_meter.avg, g_rec_loss_meter.avg, 
                                 g_kld_loss_meter.avg, d_real_loss_meter.avg, d_fake_loss1_meter.avg, d_fake_loss2_meter.avg)
