...
def parse_args():
    ...
    parser.add_argument("--expid", type=str, default='cross_attn1', required=False, help="experiment name")
    ...
    parser.add_argument("--with_infer", action='store_true', default=True, help="action to make inference after each training epoch")
    parser.add_argument("--CUDA_VISIBLE_DEVICES", default="1", help="cuda")
